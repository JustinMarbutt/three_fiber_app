// Source: https://stackoverflow.com/questions/67611934/how-to-create-water-in-react-three-fiber
...
function Ocean() {
  ...
  useFrame(
    (state, delta) => (ref.current.material.uniforms.time.value += delta - .01)
  );
  return (
    <water
      ref={ref}
